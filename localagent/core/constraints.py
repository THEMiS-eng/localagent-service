...
def build_system_prompt(project: str = None) -> str:
    ...
    Note: Active skills context is added separately via build_skill_context()
    ...
    lines = [
        ...
        "Respond with valid JSON containing a message and tasks:",
        "",
        "{",
        '  "message": "Short description of what you created (NO CODE HERE - just explain)",',
        '  "tasks": [',
        "    {",
        '      "id": "T001",',
        '      "type": "create_file",',
        ...
        '      "content": "PUT THE COMPLETE FILE CODE HERE"',
        "    }",
        "  ]",
        "}",
        "",
        "CRITICAL RULES:",
        "- 'message': Short explanation ONLY (2-3 sentences). NO code, NO HTML, NO markdown code blocks",
        "- 'content': The COMPLETE file content goes here ONLY (this will be saved as a file)",
        "- If creating a file, describe what it does in 'message', put the code in 'content'",
        "- NEVER put code in the message field - it will be displayed as ugly text",
        "- The file will be provided as a downloadable attachment automatically",
        "",

...
async def seed_releases_endpoint():
    """Seed release log with version history."""
    from ..engine.tracking import add_release_item, get_release_log
    
    releases = get_release_log(DEFAULT_PROJECT)
    if releases:
        return {"success": False, "message": "Releases already exist", "count": len(releases)}

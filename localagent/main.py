#!/usr/bin/env python3
"""
LocalAgent - Service Worker + Agent Orchestrator
...
VERSION = Path(__file__).parent.parent.joinpath("VERSION").read_text().strip() if Path(__file__).parent.parent.joinpath("VERSION").exists() else "0.0.0"
